...
module.exports.registerUser = async(req,res)=>{
    try{
        ...
        req.login(registeredUser,(err)=>{
            ...
            // for cafeowner
            if(type === "cafeOwner"){
                req.flash("success","Welcome to ChefConnect! Register your Cafe!");
                res.redirect(`/owners/new`);
            }
            // singer
            else if(type == 'singer'){
                req.flash("success","Welcome to ChefConnect! Register yourself as a snger!");
                res.redirect(`/singers/new`);
            }
            // for normaluser
            else if(type == 'normalUser'){
                req.flash("success","Welcome to ChefConnect!");
                res.redirect(`/caves`);
            }
            else{
...
module.exports.loginUser = async (req,res)=>{
    ...
    if(!redirectUrl){
        ...
        if(req.user.userType === 'cafeOwner'){
            req.flash("success","Welcome back to ChefConnect!");
